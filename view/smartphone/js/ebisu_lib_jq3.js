...
eb$.fn.ahPlaceholder = function(options)
{
    // property
    var defaults = {
        ...
        settings = eb$.extend({}, defaults, options);
    ...
    var init    = function()
        {
            ...
            eb$.data(this, 'placeholder-string', eb$(this).attr(settings.placeholderAttr));
            eb$.data(this, 'placeholder-color', eb$(this).css('color'));

            var phString    = eb$.data(this, 'placeholder-string'),
                self        = this,
                eb$self       = eb$(this);

            if ( self.value === '' ) {
                self.value = phString;
                eb$self.css('color', settings.placeholderColor);
            }

            if ( settings.likeApple === true ) {
                eb$self.bind('mousedown', moveCursorToHead);
                eb$self.bind('keydown', onKeydown);
                eb$self.bind('keyup', resetPlaceholder);
            } else {
                eb$self.bind('focus', onFocus);
                eb$self.bind('blur', resetPlaceholder);
            }

            eb$self.closest('form').submit(function() {
                if ( self.value === eb$.data(self, 'placeholder-string')
                     && eb$self.css('color') === eb$('<div/>').css('color', settings.placeholderColor).css('color')) {
                         self.value = '';
                }
                return true;
            });
        ...
        {
            if ( this.value === eb$.data(this, 'placeholder-string') ) {
                var key = keyCatch(e);
        ...
        {
            self.value = eb$.data(self, 'placeholder-string');
            eb$(self).css('color', settings.placeholderColor);
        },
        _clearPlaceholder = function(self)
        {
            self.value = '';
            eb$(self).css('color', eb$.data(self, 'placeholder-color'));
        };
    // construct
    this.each(function()
    {
